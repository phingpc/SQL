...
SELECT * from employees where Last_name in ('Deeharm');

SELECT * FROM employees where First_name = 'Natee' and Last_name = 'Deeharm' ;

SELECT * from employees where Address in ('Tasala Muangnear');

select * from employees where Address in ('Tasala Muangnear','Tasung Maungtong','Samoon Muangthai');

select * from employees where Ratehour>=2000;

select * from employees where Ratehour>=1000 and Ratehour<=2000;

select * from employees where First_name like 'S%';

select * from employees where First_name like '%S%';

select * from employees where Last_name like 'D__h%';
